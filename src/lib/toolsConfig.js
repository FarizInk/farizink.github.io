import { FileJson, Type, FileText, Calculator, GitCompare, Link2, Hash, QrCode, Palette, Calendar, Lock, RefreshCw, Zap } from '@lucide/svelte';
...
export const searchTools = (query) => {
    ...
    return getAllTools().filter(tool => tool.name.toLowerCase().includes(lowercaseQuery) ||
