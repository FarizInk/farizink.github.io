...
export const mainRoutes = [
  ...
  },
  {
    ...
    description:
      'Explore my software development projects and open-source contributions. Building innovative solutions with modern technologies.',
    keywords:
      'software projects, web development projects, open source, programming portfolio, github projects',
    robots: 'index, follow'
  },
  {
    ...
    description:
      'Modern bento grid layout personal profile example with cards, skills, and contact information.',
