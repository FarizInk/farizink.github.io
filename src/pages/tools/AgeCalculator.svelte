      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        >
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
            <Clock class="w-5 h-5 mr-2 text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)]" />
            Your Age
          </h2>
          ...
          <div class="text-center mb-8">
            ...
            >
              <div class="text-6xl font-bold text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)] mb-4">
                {years}
              </div>
              <div class="text-lg font-medium text-[var(--ds-primary-700)] dark:text-[var(--ds-primary-300)]">Years</div>
        ...
        >
          ...
          <div class="text-center">
            {#if isBirthdayToday}
              ...
              <div class="p-4 bg-[var(--ds-primary-100)] dark:bg-[var(--ds-primary-900)/20] rounded-lg">
                <h3 class="text-lg font-medium text-[var(--ds-primary-800)] dark:text-[var(--ds-primary-200)] mb-2">
                  Countdown to Next Birthday
                </h3>
                <div class="grid grid-cols-4 gap-2 text-center">
                  <div>
                    <div class="text-2xl font-bold text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)]">
                      {countdownTime.days}
                    </div>
                    <div class="text-xs text-[var(--ds-primary-700)] dark:text-[var(--ds-primary-300)]">Days</div>
                  </div>
                  <div>
                    <div class="text-2xl font-bold text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)]">
                      {countdownTime.hours}
                    </div>
                    <div class="text-xs text-[var(--ds-primary-700)] dark:text-[var(--ds-primary-300)]">Hours</div>
                  </div>
                  <div>
                    <div class="text-2xl font-bold text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)]">
                      {countdownTime.minutes}
                    </div>
                    <div class="text-xs text-[var(--ds-primary-700)] dark:text-[var(--ds-primary-300)]">Minutes</div>
                  </div>
                  <div>
                    <div class="text-2xl font-bold text-[var(--ds-primary-600)] dark:text-[var(--ds-primary-400)]">
                      {countdownTime.seconds}
                    </div>
                    <div class="text-xs text-[var(--ds-primary-700)] dark:text-[var(--ds-primary-300)]">Seconds</div>
                  </div>
                </div>
              </div>
            {:else}
