<script lang="ts">
  ...
  import { ChevronLeft, Hash, Copy, Zap, FileText } from '@lucide/svelte';

  let inputText = $state('');
  let hashAlgorithm = $state('sha256');
  let outputFormat = $state('hex');
...
<div class="max-w-6xl mx-auto p-6">
  ...
  <div class="mb-8">
    ...
    <div class="text-center mb-8">
      <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl mb-4">
    ...
    <div class="space-y-4 mb-6">
      {#each Object.entries(hashes) as [algorithm, hash]}
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div class="relative">
            <div class="p-3 bg-gray-50 dark:bg-gray-900 rounded-lg font-mono text-sm text-gray-900 dark:text-white break-all">
              {hash}
            </div>
          </div>
        </div>
  ...
  <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
      <div class="w-12 h-12 bg-amber-100 dark:bg-amber-900/20 rounded-lg flex items-center justify-center mb-4">
