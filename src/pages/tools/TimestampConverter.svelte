<script lang="ts">
  ...
  import { ChevronLeft, Calendar, Copy, Zap, RefreshCw } from '@lucide/svelte';
  ...
  const dateFormats = {
    ...
    readable: 'dddd, MMMM D, YYYY at h:mm:ss A',
    short: 'MMM D, YYYY',
    time: 'HH:mm:ss',
    date: 'YYYY-MM-DD'
  };
...
<div class="max-w-6xl mx-auto p-6">
  ...
  <div class="mb-8">
    ...
    <div class="text-center mb-8">
      <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl mb-4">
  ...
  <!-- Current Timestamp -->
  <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl border border-orange-200 dark:border-orange-800 p-6 mb-6">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          Used in programming, databases, APIs, and systems for consistent date/time representation across timezones.
        </p>
      </div>
    </div>
  </div>
