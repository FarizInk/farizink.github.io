<script lang="ts">
  ...
  import { DollarSign, Calculator, Users, Copy } from '@lucide/svelte';
            ...
            <div class="grid grid-cols-5 gap-2">
              {#each tipPresets as preset (preset)}
                <button
                  ...
                  class="px-3 py-2 text-sm rounded-lg border transition-colors {tipPercentage ===
                  preset
                                  ...
                                  <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex justify-between items-center">
                                      ...
                                      <div class="flex items-center gap-2">
                                        ...
                                        <div
                                          class="pt-3 border-t border-green-200 dark:border-green-800"
                                        >
                                          <div class="flex justify-between items-center">
                                            <span class="text-gray-600 dark:text-gray-400"
                                              >Per Person:</span
                                            ...
                                            <div class="flex items-center gap-2">
                                              ...
                                              <button
                                                onclick={() =>
                                                  copyToClipboard(amountPerPerson.toFixed(2))}
                                                class="btn btn-primary btn-sm"
                                              >
                                                <Copy class="w-4 h-4" />
                                              </button>
                                                ...
                                                >
                                                  ...
                                                  >
                                                    ...
                                                    <p class="text-gray-600 dark:text-gray-400">
                                                      Calculate tips with customizable percentages
                                                      and preset options
                                                    </p>
                                                      ...
                                                      >
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            ...
                                                            >
                                                              Include tax calculations by amount or
                                                              percentage for accurate totals
                                                            </p>
                                                          </div>
                                                        </div>
                                                      </div>
