    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
      ...
      <div>
        ...
        <textarea
          ...
          class="code-editor h-48 sm:h-64 lg:h-96"
        ></textarea>
      </div>
      ...
      <div>
        ...
        <div
          class="h-48 sm:h-64 lg:h-96 overflow-y-auto border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-900 p-4"
        >
          {#if batchResults.length === 0}
