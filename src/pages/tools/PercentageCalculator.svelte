    ...
    <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {#each modes as mode (mode.id)}
          ...
          >
            <mode.icon class="w-6 h-6 mb-2 text-primary-600 dark:text-primary-400" />
      ...
      >
        ...
        {#if activeMode === 'basic'}
          <div class="space-y-6">
            ...
            {#if result}
              <div
                class="p-4 bg-primary-100 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg"
              >
                <div class="flex items-center justify-between">
                  <div>
                    <p class="text-sm text-primary-600 dark:text-primary-400 mb-1">Result</p>
                  ...
                  <button
                    ...
                    class="p-2 text-primary-600 dark:text-primary-400 hover:text-blue-700 dark:hover:text-blue-300"
                  >
                    <Copy class="w-5 h-5" />
                  </button>
                </div>
          ...
          <div class="space-y-6">
            ...
            {#if changedResult}
              ...
              >
                <div class="flex items-center justify-between">
                  <div>
                    <p class="text-sm text-primary-600 dark:text-primary-400 mb-1">New Value</p>
                  ...
                  <button
                    ...
                    class="p-2 text-primary-600 dark:text-primary-400 hover:text-green-700 dark:hover:text-green-300"
                  >
                    <Copy class="w-5 h-5" />
                  </button>
                </div>
            ...
            {#if discountedPrice}
              <div class="space-y-4">
                ...
                <div
                  class="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg"
                >
                  <p class="text-sm text-primary-600 dark:text-primary-400 mb-1">You Save</p>
              ...
              <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                  <div
                    class="p-4 bg-primary-100 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg"
                  >
                    <p class="text-sm text-primary-600 dark:text-primary-400 mb-1">Tip Amount</p>
      ...
      >
        ...
        <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
          <div class="flex items-start">
            <div class="w-2 h-2 bg-primary-500 rounded-full mt-1.5 mr-2"></div>
