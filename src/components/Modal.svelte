...
{#if isOpen}
	<div class="fixed inset-0 z-10 overflow-y-auto flex items-center justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
		<div 
		...
		></div>
		<div class="flex items-center sm:items-center justify-center min-h-full w-full p-4 text-center sm:p-0">
			<div
