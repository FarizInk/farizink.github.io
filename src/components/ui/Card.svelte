<script lang="ts">
  ...
  const variantClasses = $derived(
    {
      ...
      elevated:
        'bg-white dark:bg-gray-800 border border-transparent shadow-lg hover:shadow-xl dark:shadow-gray-900/50 dark:hover:shadow-gray-900/70',
  ...
  const interactionClasses = $derived({
    ...
    clickable: clickable
      ? 'cursor-pointer hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-600'
      : ''
  });
