import{u as ue,h as xe,p as ye,f as R,k as q,aq as h,s as D,m as r,ae as we,bL as I,ag as F,c as e,ah as O,i as fe,aK as ke,bu as _e,r as Le,aR as Te,b as d,g as t,e as u,d as $e,Q as Se,l as Ce,j as Me,aa as He}from"./vendor-Deqr-a52.js";import{T as Pe}from"./ToolLayout-CLbms16I.js";import{t as g}from"./notifications-CPP2xv5g.js";import"./router-3g4WN2IJ.js";function je(l,o){navigator.clipboard.writeText(t(o)),g.success("Markdown copied to clipboard")}function Ee(l,o){navigator.clipboard.writeText(t(o)),g.success("HTML copied to clipboard")}function qe(l,o,a){d(o,`# Sample Markdown Document
...
`).length);ue(()=>{x()}),Pe(l,{title:"Markdown Preview",description:"Preview markdown text with live rendering and syntax highlighting.",get icon(){return h},color:"warning",children:(v,p)=>{var s=Fe(),y=q(s),A=e(y),B=e(A),N=e(B),Y=e(N);h(Y,{class:"w-6 h-6 text-white"});var w=r(y,2),f=e(w),k=e(f);h(k,{class:"w-4 h-4"});var G=r(k,2),V=e(G),_=r(f,2);_.__click=[qe,a,x];var z=r(_,2);z.__click=[De,a,i];var L=r(w,2),T=e(L),$=e(T),S=e($),J=e(S);we(J,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var C=r(S,2);C.__click=[je,a];var K=e(C);I(K,{class:"w-4 h-4"});var Q=r($,2),Z=e(Q),X=r(T,2),M=e(X),H=e(M),ee=e(H);F(ee,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var re=r(H,2),m=e(re);m.__click=[Ee,i];var te=e(m);I(te,{class:"w-4 h-4"});var P=r(m,2);P.__click=U;var ae=e(P);O(ae,{class:"w-4 h-4"});var ie=r(M,2),oe=e(ie);{var ne=n=>{var c=Me(),b=q(c);He(b,()=>t(i)),u(n,c)},se=n=>{var c=Ie(),b=e(c),he=e(b);F(he,{class:"w-12 h-12 mb-2 opacity-50 mx-auto"}),u(n,c)};fe(oe,n=>{t(i)?n(ne):n(se,!1)})}var de=r(L,2),j=e(de),le=e(j),ce=e(le);ke(ce,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var E=r(j,2),ge=e(E),ve=e(ge);_e(ve,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var pe=r(E,2),me=e(pe),be=e(me);O(be,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"}),Le(()=>Se(V,`${t(W)??""} lines`)),Te(Z,()=>t(a),n=>d(a,n)),u(v,s)},$$slots:{default:!0}}),xe()}$e(["click"]);export{Ae as default};
