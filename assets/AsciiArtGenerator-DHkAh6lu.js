...
|__)`,7:` __ 
   /`,8:` __ 
|__)`,9:` __ 
|__/`}}};function $(){if(!a(t).trim()){i(d,"");return}const c=a(t).toUpperCase(),g=M[a(j)],s=[];for(let o=0;o<5;o++){let v="";for(let x=0;x<c.length;x++){const w=c[x];if(g.chars[w]){const C=g.chars[w].split(`
`);C[o]?v+=C[o]+" ":v+=" ".repeat(6)+" "}else v+=" ".repeat(6)+" "}s.push(v.trimEnd())}i(d,s.join(`
`),!0)}function q(){const c=new Blob([a(d)],{type:"text/plain"}),g=URL.createObjectURL(c),s=document.createElement("a");s.href=g,s.download="ascii-art.txt",s.click(),URL.revokeObjectURL(g),U.success("ASCII art downloaded")}mn(()=>{$()}),En(b,{title:"ASCII Art Generator",description:"Convert text into ASCII art with different styles. Perfect for terminal displays and creative text art.",get icon(){return X},color:"warning",children:(c,g)=>{var s=Kn(),o=O(s),v=n(o),x=n(v),w=n(x),C=n(w);X(C,{class:"w-6 h-6 text-white"});var K=r(o,2),W=n(K);W.__click=[Bn,t,$];var z=r(W,2);z.__click=[Pn,t,d];var Z=r(K,2),nn=r(n(Z),2);yn(nn,21,()=>Object.entries(M),In,(l,I)=>{var y=Tn(()=>jn(a(I),2));let p=()=>a(y)[0],h=()=>a(y)[1];var _=Dn();_.__click=[On,j,p];var E=n(_),S=n(E),A=n(S),R=r(S,2),P=n(R);D(()=>{An(_,1,`preset-btn p-4 border-2 rounded-lg transition-all text-left ${a(j)===p()?"border-warning-400 dark:border-primary-500 bg-warning-50 dark:bg-primary-900/20":"border-gray-200 dark:border-gray-600 hover:border-warning-300 dark:hover:border-primary-400"}`),L(A,h().name),L(P,p()==="standard"?"Classic ASCII style with standard characters":p()==="block"?"Bold block style using full Unicode blocks":"Minimal style using basic ASCII characters")}),f(l,_)});var H=r(Z,2),N=n(H),tn=r(n(N),2),rn=n(tn),Q=r(N,2);hn(Q,"maxlength",10);var F=r(H,2);{var an=l=>{var I=$n(),y=n(I),p=r(n(y),2),h=n(p);h.__click=[Rn,d,G];var _=n(h);{var E=m=>{var u=Gn(),B=O(u);Ln(B,{class:"w-4 h-4 mr-2"}),f(m,u)},S=m=>{var u=Mn(),B=O(u);Un(B,{class:"w-4 h-4 mr-2"}),f(m,u)};Y(_,m=>{a(G)==="ascii"?m(E):m(S,!1)})}var A=r(h,2);A.__click=q;var R=n(A);Sn(R,{class:"w-4 h-4 mr-2"});var P=r(y,2),pn=n(P),_n=n(pn);D(()=>L(_n,a(d))),f(l,I)};Y(F,l=>{a(d)&&l(an)})}var en=r(F,6),J=n(en),sn=n(J),dn=n(sn);un(dn,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var V=r(J,2),on=n(V),ln=n(on);fn(ln,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var cn=r(V,2),gn=n(cn),vn=n(gn);kn(vn,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"}),D(()=>L(rn,`${a(t).length??""} characters`)),wn(Q,()=>a(t),l=>i(t,l)),f(c,s)},$$slots:{default:!0}}),bn()}Cn(["click"]);export{Qn as default};
