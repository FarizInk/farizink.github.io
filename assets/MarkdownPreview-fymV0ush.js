import{u as ue,h as xe,p as ye,f as R,k as I,ao as h,s as D,m as r,ae as we,bI as q,ag as F,c as e,ah as O,i as fe,aI as ke,br as _e,r as Le,aP as Te,b as d,g as t,e as u,d as $e,Q as Se,l as Ce,j as Me,aa as Pe}from"./vendor-DiLsTAmk.js";import{T as He}from"./ToolLayout-IrUKlq8P.js";import{t as g}from"./notifications-DYoUwq6c.js";import"./router-CPj5Jzo3.js";function je(l,i){navigator.clipboard.writeText(t(i)),g.success("Markdown copied to clipboard")}function Ee(l,i){navigator.clipboard.writeText(t(i)),g.success("HTML copied to clipboard")}function Ie(l,i,a){d(i,`# Sample Markdown Document
...
*Thank you for using Markdown Preview!*`),o=D("");function x(){d(o,t(a).replace(/^### (.*$)/gm,'<h3 class="text-xl font-semibold mb-3 mt-6">$1</h3>').replace(/^## (.*$)/gm,'<h2 class="text-2xl font-semibold mb-4 mt-8">$1</h2>').replace(/^# (.*$)/gm,'<h1 class="text-3xl font-bold mb-6 mt-8">$1</h1>').replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/```(.*?)\n([\s\S]*?)```/g,'<pre class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg overflow-x-auto mb-4"><code class="text-sm font-mono">$2</code></pre>').replace(/`(.*?)`/g,'<code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-sm font-mono">$1</code>').replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" class="text-primary-600 dark:text-primary-400 hover:underline" target="_blank" rel="noopener noreferrer">$1</a>').replace(/^- (.*$)/gm,'<li class="ml-4">$1</li>').replace(/(<li.*>.*<\/li>)/s,'<ul class="list-disc mb-4">$1</ul>').replace(/\n\n/g,'</p><p class="mb-4">').replace(/\n/g,"<br>"),!0),t(o)&&!t(o).startsWith("<")&&d(o,'<p class="mb-4">'+t(o)+"</p>")}function U(){const v=new Blob([t(o)],{type:"text/html"}),p=URL.createObjectURL(v),s=document.createElement("a");s.href=p,s.download="markdown-preview.html",s.click(),URL.revokeObjectURL(p),g.success("HTML downloaded")}const W=Ce(()=>t(a).split(`
`).length);ue(()=>{x()}),He(l,{title:"Markdown Preview",description:"Preview markdown text with live rendering and syntax highlighting.",get icon(){return h},color:"warning",children:(v,p)=>{var s=Fe(),y=I(s),A=e(y),B=e(A),N=e(B),Y=e(N);h(Y,{class:"w-6 h-6 text-white"});var w=r(y,2),f=e(w),k=e(f);h(k,{class:"w-4 h-4"});var G=r(k,2),V=e(G),_=r(f,2);_.__click=[Ie,a,x];var z=r(_,2);z.__click=[De,a,o];var L=r(w,2),T=e(L),$=e(T),S=e($),J=e(S);we(J,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var C=r(S,2);C.__click=[je,a];var Q=e(C);q(Q,{class:"w-4 h-4"});var Z=r($,2),K=e(Z),X=r(T,2),M=e(X),P=e(M),ee=e(P);F(ee,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var re=r(P,2),m=e(re);m.__click=[Ee,o];var te=e(m);q(te,{class:"w-4 h-4"});var H=r(m,2);H.__click=U;var ae=e(H);O(ae,{class:"w-4 h-4"});var oe=r(M,2),ie=e(oe);{var ne=n=>{var c=Me(),b=I(c);Pe(b,()=>t(o)),u(n,c)},se=n=>{var c=qe(),b=e(c),he=e(b);F(he,{class:"w-12 h-12 mb-2 opacity-50 mx-auto"}),u(n,c)};fe(ie,n=>{t(o)?n(ne):n(se,!1)})}var de=r(L,2),j=e(de),le=e(j),ce=e(le);ke(ce,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var E=r(j,2),ge=e(E),ve=e(ge);_e(ve,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var pe=r(E,2),me=e(pe),be=e(me);O(be,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"}),Le(()=>Se(V,`${t(W)??""} lines`)),Te(K,()=>t(a),n=>d(a,n)),u(v,s)},$$slots:{default:!0}}),xe()}$e(["click"]);export{Ae as default};
