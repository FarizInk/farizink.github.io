import{u as ue,h as xe,p as ye,f as R,k as D,ar as h,s as I,m as r,af as we,bM as q,ah as F,c as e,ai as O,i as fe,aL as ke,bv as _e,x as Le,aS as Se,b as d,g as t,e as u,d as Te,S as $e,n as Me,j as Ce,ab as He}from"./vendor-CYhhcCQ3.js";import{T as Pe}from"./ToolLayout-BpaAidUh.js";import{t as g}from"./notifications-Cc4Eusmt.js";import"./router-CF5VSPvA.js";function je(l,o){navigator.clipboard.writeText(t(o)),g.success("Markdown copied to clipboard")}function Ee(l,o){navigator.clipboard.writeText(t(o)),g.success("HTML copied to clipboard")}function De(l,o,a){d(o,`# Sample Markdown Document
...
*Thank you for using Markdown Preview!*`),i=I("");function x(){d(i,t(a).replace(/^### (.*$)/gm,'<h3 class="text-xl font-semibold mb-3 mt-6">$1</h3>').replace(/^## (.*$)/gm,'<h2 class="text-2xl font-semibold mb-4 mt-8">$1</h2>').replace(/^# (.*$)/gm,'<h1 class="text-3xl font-bold mb-6 mt-8">$1</h1>').replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/```(.*?)\n([\s\S]*?)```/g,'<pre class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg overflow-x-auto mb-4"><code class="text-sm font-mono">$2</code></pre>').replace(/`(.*?)`/g,'<code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-sm font-mono">$1</code>').replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" class="text-primary-600 dark:text-primary-400 hover:underline" target="_blank" rel="noopener noreferrer">$1</a>').replace(/^- (.*$)/gm,'<li class="ml-4">$1</li>').replace(/(<li.*>.*<\/li>)/s,'<ul class="list-disc mb-4">$1</ul>').replace(/\n\n/g,'</p><p class="mb-4">').replace(/\n/g,"<br>"),!0),t(i)&&!t(i).startsWith("<")&&d(i,'<p class="mb-4">'+t(i)+"</p>")}function U(){const v=new Blob([t(i)],{type:"text/html"}),p=URL.createObjectURL(v),s=document.createElement("a");s.href=p,s.download="markdown-preview.html",s.click(),URL.revokeObjectURL(p),g.success("HTML downloaded")}const W=Me(()=>t(a).split(`
`).length);ue(()=>{x()}),Pe(l,{title:"Markdown Preview",description:"Preview markdown text with live rendering and syntax highlighting.",get icon(){return h},color:"warning",children:(v,p)=>{var s=Fe(),y=D(s),A=e(y),B=e(A),N=e(B),Y=e(N);h(Y,{class:"w-6 h-6 text-white"});var w=r(y,2),f=e(w),k=e(f);h(k,{class:"w-4 h-4"});var G=r(k,2),V=e(G),_=r(f,2);_.__click=[De,a,x];var z=r(_,2);z.__click=[Ie,a,i];var L=r(w,2),S=e(L),T=e(S),$=e(T),J=e($);we(J,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var M=r($,2);M.__click=[je,a];var Z=e(M);q(Z,{class:"w-4 h-4"});var K=r(T,2),Q=e(K),X=r(S,2),C=e(X),H=e(C),ee=e(H);F(ee,{class:"w-4 h-4 text-gray-600 dark:text-gray-400"});var re=r(H,2),m=e(re);m.__click=[Ee,i];var te=e(m);q(te,{class:"w-4 h-4"});var P=r(m,2);P.__click=U;var ae=e(P);O(ae,{class:"w-4 h-4"});var ie=r(C,2),oe=e(ie);{var ne=n=>{var c=Ce(),b=D(c);He(b,()=>t(i)),u(n,c)},se=n=>{var c=qe(),b=e(c),he=e(b);F(he,{class:"w-12 h-12 mb-2 opacity-50 mx-auto"}),u(n,c)};fe(oe,n=>{t(i)?n(ne):n(se,!1)})}var de=r(L,2),j=e(de),le=e(j),ce=e(le);ke(ce,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var E=r(j,2),ge=e(E),ve=e(ge);_e(ve,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"});var pe=r(E,2),me=e(pe),be=e(me);O(be,{class:"w-6 h-6 text-warning-600 dark:text-primary-400"}),Le(()=>$e(V,`${t(W)??""} lines`)),Se(Q,()=>t(a),n=>d(a,n)),u(v,s)},$$slots:{default:!0}}),xe()}Te(["click"]);export{Ae as default};
